...
const newprojectcard = ({ image, title, description, background, textColor, slug }: any) => {
    return (
        <div className={`md:flex md:flex-row md:even:flex-row-reverse md:min-h-[100vh] w-full`} style={{
            ...
            <div className="md:w-[50%] w-full flex items-center justify-center px-12 pt-5 pb-12 ">
                <div className={`flex flex-col md:w-[80%] w-full gap-4`} style={{ color: textColor }}>
                    <h1 className="font-sora md:text-4xl text-xl font-semibold">{title}</h1>
