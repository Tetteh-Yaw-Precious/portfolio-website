...
function Herosection() {
  return (
    <>
      <motion.section className='xl:h-[88vh] min-h-[100vh] flex flex-col items-center justify-center'>
        <motion.div
        ...
        >
          <motion.h1
            ...
            initial='initial'
            animate='animate'
            className='md:text-8xl text-4xl text-black !leading-[100%] text-center font-semibold font-clash tracking-loose w-[70%]'
          >
            Designing Products, Brands & Businesses</motion.h1>
          <p className='italic text-xl'> passionately from Accra Ghana 🇬🇭, I’m Yaw Precious</p>
          {/* <motion.a
      ...
      <div className='uppercase h-[250px] flex items-center bg-[#191819] text-[#F5FFEC]'>
        <Marquee speed={200} pauseOnHover={true}>
          <h1 className='text-4xl px-6 font-clash'>1. People First </h1>
          <h1 className='text-4xl px-6 font-clash'> 2. Data Driven Design</h1>
          <h1 className='text-4xl px-6 font-clash'>3. Strategic Execution </h1>
        </Marquee>
      </div>
    </>
