            ...
            <div className="flex items-center justify-center w-full">
              <div className=" w-[100%] flex flex-col items-center justify-center gap-8">
                <div className="flex flex-col items-center w-full md:flex md:flex-col md:items-center md:justify-center">
                  <p className="md:text-xl font-dgrotesk font-extralight md:text-start text-center !text-white">
          ...
          <hr className="w-32 h-1 my-2 text-white bg-white border rounded-2xl" />
                ...
                <div className="flex flex-col items-center justify-center gap-6 md:flex-row">
                  <a
                    ...
                    className="flex items-center font-dgrotesk justify-center gap-2 px-10 rounded-[0.5rem] py-3 text-lg text-center text-white shadow-neubrutalism-white transition ease-in border-2 delay-2"
                  >
                  ...
                  <a
                    className="flex items-center font-dgrotesk justify-center gap-2 px-10 py-3 rounded-[8px] text-lg text-center text-white transition shadow-neubrutalism-white ease-in border-2 rounded-75xl delay-2"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    ...
                    className="flex items-center font-dgrotesk justify-center gap-2 px-12 py-3 text-lg text-center text-white transition shadow-neubrutalism-white ease-in border-2 rounded-[0.5rem] delay-2 rounded-75xl"
                  >
                    <div className="flex border-white ">
