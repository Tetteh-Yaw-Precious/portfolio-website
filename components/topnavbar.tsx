    ...
    <>
      ...
      {isMedium && (
        <div className='z-[100] fixed top-0 w-full bg-white'>
          <nav className='h-[10vh] flex gap-10 items-center justify-center text-lg font-outfit'>
            {menuLinks.map((link, index) => (
              <a href={link.href} key={index} className="!scroll-smooth">
                <motion.a
                  className='font-medium scroll-smooth'
